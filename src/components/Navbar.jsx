  ...
  return (
    ...
    <div className="navbar bg-base-300">
        ...
        <div className="navbar-center">
            {user ? 
            <>
               {user && <Link to={'/profile'}><h1 className="btn btn-ghost normal-case text-xl"> {user.image && <img className='w-10 rounded-full' src={import.meta.env.VITE_IMAGE_URL + 'profile-img/' + user.image} alt="" />}  {user.first_name + ' ' + user.last_name}</h1></Link>}
            </> : 
